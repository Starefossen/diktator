    ...
    "paths": {
        ...
        "/api/families/children": {
            ...
            "post": {
                ...
                "description": "Add an existing child user to the family (parent only)\nThis assumes the child already has an account in Zitadel.\nThe child will be linked to the family when they first log in.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Service unavailable or failed to add child",
                        "schema": {
                            "$ref": "#/definitions/models.APIResponse"
                        }
                    }
