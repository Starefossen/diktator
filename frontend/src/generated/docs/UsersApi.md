...
|------------- | ------------- | -------------|
|[**apiUsersMeNamePatch**](#apiusersmenamepatch) | **PATCH** /api/users/me/name | Update User Display Name|
...
# **apiUsersMeNamePatch**
> ModelsAPIResponse apiUsersMeNamePatch(body)
...
const { status, data } = await apiInstance.apiUsersMeNamePatch(
    body
);
```
