...
const translations = {
  en: {
    ...
    'home.subtitle': 'A fun and interactive spelling practice app designed especially for children',
    ...
    'home.practice.desc': 'Practice spelling with our interactive word games and improve your skills!',
    'home.practice.button': 'Begin Practice',
    'home.about.title': 'Learn More',
    'home.about.desc': 'Discover how Diktator can help children develop better spelling skills.',
    'home.about.button': 'About Us',
    'about.title': 'About Diktator',
    'about.what.title': 'What is Diktator?',
    'about.what.desc': 'Diktator is a fun and interactive spelling practice application designed specifically for children. Our goal is to make learning spelling enjoyable and engaging through modern web technology.',
    ...
    'about.development.desc': 'This application is built with modern development practices including Infrastructure as Code (Terraform), automated CI/CD pipelines (GitHub Actions), and streamlined local development using mise for task management.',
  },
  no: {
    ...
    'home.subtitle': 'En morsom og interaktiv stavepraksis-app designet spesielt for barn',
    ...
    'home.practice.desc': 'Øv på staving med våre interaktive ordspill og forbedre ferdighetene dine!',
    'home.practice.button': 'Begynn øving',
    'home.about.title': 'Lær mer',
    'home.about.desc': 'Oppdag hvordan Diktator kan hjelpe barn med å utvikle bedre staveferdigheter.',
    'home.about.button': 'Om oss',
    'about.title': 'Om Diktator',
    'about.what.title': 'Hva er Diktator?',
    'about.what.desc': 'Diktator er en morsom og interaktiv stavepraksis-applikasjon designet spesielt for barn. Vårt mål er å gjøre ståvelæring hyggelig og engasjerende gjennom moderne webteknologi.',
    ...
    'about.development.desc': 'Denne applikasjonen er bygget med moderne utviklingspraksis inkludert Infrastructure as Code (Terraform), automatiserte CI/CD-pipelines (GitHub Actions), og strømlinjeformet lokal utvikling med mise for oppgavehåndtering.',
  }
}
